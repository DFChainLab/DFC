...
CHAINBASE_SET_INDEX_TYPE(dfcio::chain::transaction_object, dfcio::chain::transaction_multi_index)

FC_REFLECT(dfcio::chain::transaction_object, (expiration)(trx_id))
