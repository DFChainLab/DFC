...
CHAINBASE_SET_INDEX_TYPE(dfcio::chain::permission_link_object, dfcio::chain::permission_link_index)

FC_REFLECT(dfcio::chain::permission_link_object, (account)(code)(message_type)(required_permission))
