#pragma once
#include <dfcio/chain/block_header.hpp>
...
FC_REFLECT_ENUM( dfcio::chain::transaction_receipt::status_enum,
                 (executed)(soft_fail)(hard_fail)(delayed)(expired) )

FC_REFLECT(dfcio::chain::transaction_receipt_header, (status)(cpu_usage_us)(net_usage_words) )
FC_REFLECT_DERIVED(dfcio::chain::transaction_receipt, (dfcio::chain::transaction_receipt_header), (trx) )
FC_REFLECT_DERIVED(dfcio::chain::signed_block, (dfcio::chain::signed_block_header), (transactions)(block_extensions) )
