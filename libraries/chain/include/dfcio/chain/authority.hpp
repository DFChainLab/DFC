...
FC_REFLECT(dfcio::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(dfcio::chain::key_weight, (key)(weight) )
FC_REFLECT(dfcio::chain::wait_weight, (wait_sec)(weight) )
FC_REFLECT(dfcio::chain::authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(dfcio::chain::shared_authority, (threshold)(keys)(accounts)(waits) )
