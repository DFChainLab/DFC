...
#include <dfcio/chain/multi_index_includes.hpp>
...
CHAINBASE_SET_INDEX_TYPE(dfcio::chain::table_id_object, dfcio::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(dfcio::chain::key_value_object, dfcio::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(dfcio::chain::index64_object, dfcio::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(dfcio::chain::index128_object, dfcio::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(dfcio::chain::index256_object, dfcio::chain::index256_index)
CHAINBASE_SET_INDEX_TYPE(dfcio::chain::index_double_object, dfcio::chain::index_double_index)
CHAINBASE_SET_INDEX_TYPE(dfcio::chain::index_long_double_object, dfcio::chain::index_long_double_index)

FC_REFLECT(dfcio::chain::table_id_object, (code)(scope)(table)(payer)(count) )
FC_REFLECT(dfcio::chain::key_value_object, (primary_key)(payer)(value) )

#define REFLECT_SECONDARY(type)\
  FC_REFLECT(type, (primary_key)(payer)(secondary_key) )

REFLECT_SECONDARY(dfcio::chain::index64_object)
REFLECT_SECONDARY(dfcio::chain::index128_object)
REFLECT_SECONDARY(dfcio::chain::index256_object)
REFLECT_SECONDARY(dfcio::chain::index_double_object)
REFLECT_SECONDARY(dfcio::chain::index_long_double_object)
