...
CHAINBASE_SET_INDEX_TYPE(dfcio::chain::generated_transaction_object, dfcio::chain::generated_transaction_multi_index)

FC_REFLECT(dfcio::chain::generated_transaction_object, (trx_id)(sender)(sender_id)(payer)(delay_until)(expiration)(published)(packed_trx))