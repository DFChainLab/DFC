...
using action_name    = dfcio::chain::action_name;
...
FC_REFLECT( dfcio::chain::newaccount                       , (creator)(name)(owner)(active) )
FC_REFLECT( dfcio::chain::setcode                          , (account)(vmtype)(vmversion)(code) )
FC_REFLECT( dfcio::chain::setabi                           , (account)(abi) )
FC_REFLECT( dfcio::chain::updateauth                       , (account)(permission)(parent)(auth) )
FC_REFLECT( dfcio::chain::deleteauth                       , (account)(permission) )
FC_REFLECT( dfcio::chain::linkauth                         , (account)(code)(type)(requirement) )
FC_REFLECT( dfcio::chain::unlinkauth                       , (account)(code)(type) )
FC_REFLECT( dfcio::chain::canceldelay                      , (canceling_auth)(trx_id) )
FC_REFLECT( dfcio::chain::onerror                          , (sender_id)(sent_trx) )
