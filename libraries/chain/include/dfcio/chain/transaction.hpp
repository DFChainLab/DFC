...
#include <dfcio/chain/action.hpp>
#include <numeric>
...
FC_REFLECT( dfcio::chain::transaction_header, (expiration)(ref_block_num)(ref_block_prefix)
                                              (max_net_usage_words)(max_cpu_usage_ms)(delay_sec) )
FC_REFLECT_DERIVED( dfcio::chain::transaction, (dfcio::chain::transaction_header), (context_free_actions)(actions)(transaction_extensions) )
FC_REFLECT_DERIVED( dfcio::chain::signed_transaction, (dfcio::chain::transaction), (signatures)(context_free_data) )
FC_REFLECT_ENUM( dfcio::chain::packed_transaction::compression_type, (none)(zlib))
FC_REFLECT( dfcio::chain::packed_transaction, (signatures)(compression)(packed_context_free_data)(packed_trx) )
FC_REFLECT_DERIVED( dfcio::chain::deferred_transaction, (dfcio::chain::signed_transaction), (sender_id)(sender)(payer)(execute_after) )
FC_REFLECT( dfcio::chain::deferred_reference, (sender)(sender_id) )
