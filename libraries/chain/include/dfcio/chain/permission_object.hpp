...
CHAINBASE_SET_INDEX_TYPE(dfcio::chain::permission_object, dfcio::chain::permission_index)
CHAINBASE_SET_INDEX_TYPE(dfcio::chain::permission_usage_object, dfcio::chain::permission_usage_index)

FC_REFLECT(dfcio::chain::permission_object, (usage_id)(parent)(owner)(name)(last_updated)(auth))
FC_REFLECT(dfcio::chain::snapshot_permission_object, (parent)(owner)(name)(last_updated)(last_used)(auth))

FC_REFLECT(dfcio::chain::permission_usage_object, (last_used))
