...
CHAINBASE_SET_INDEX_TYPE( dfcio::account_control_history_object, dfcio::account_control_history_multi_index )

FC_REFLECT( dfcio::account_control_history_object, (controlled_account)(controlled_permission)(controlling_account) )
