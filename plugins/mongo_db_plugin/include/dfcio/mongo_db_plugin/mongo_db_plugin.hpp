 ...
 * account_controls
 *
 *   See data dictionary (DB Schema Definition - DFC API) for description of MongoDB schema.
 *
...
FC_REFLECT( dfcio::mongo_db_plugin::transfer                         , (from)(to)(quantity)(memo) )
FC_REFLECT( dfcio::mongo_db_plugin::addlimitlog                      , (block_id)(account)(limit_double)(transfer_type)(transfer_symbol) )
FC_REFLECT( dfcio::mongo_db_plugin::endreward                        , (block_id)(account)(quantity) )
