...
namespace  dfcio {
    ...
    *  @brief Defines DFCIO Singleton Table
    *  @ingroup databasecpp 
    *  @{
    */
   ...
   class singleton
   {
      ...
      struct row {
         ...
         DFCLIB_SERIALIZE( row, (value) )
      };

      typedef dfcio::multi_index<SingletonName, row> table;
      ...
      public:
         ...
         T get() {
            ...
            dfcio_assert( itr != _t.end(), "singleton does not exist" );
            return itr->value;
         }
