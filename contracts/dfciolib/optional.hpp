   ...
   class optional {
      public:
         ...
         */
          ...
          */
         T&       operator*()      { dfcio_assert(_valid, "dereference of empty optional"); return ref(); }
          ...
          * @return T& - Contained value
          */
         const T& operator*()const { dfcio_assert(_valid, "dereference of empty optional"); return ref(); }
         ...
         T*       operator->()
         {
            dfcio_assert(_valid, "dereference of empty optional");
            return ptr();
         }
         ...
         *  @return dfcio::datastream<Stream>& - Reference to the datastream
         */
         template<typename Stream>
         friend inline dfcio::datastream<Stream>& operator>> (dfcio::datastream<Stream>& ds, optional& op)
         {
            char valid = 0;
            ds >> valid;
            if (valid) {
         ...
         */
         template<typename Stream>
         friend inline dfcio::datastream<Stream>& operator<< (dfcio::datastream<Stream>& ds, const optional& op)
         {
