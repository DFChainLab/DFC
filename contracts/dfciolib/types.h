 ...
 * @details DFCIO Public Key. It is 34 bytes.
 */
struct public_key {
   char data[34];
};
...
/**
 * @brief DFCIO Signature
 * @details DFCIO Signature. It is 66 bytes.
 */
struct signature {
   uint8_t data[66];
};
...
/**
 * @brief Type of DFCIO Transaction Id
 * @details Type of DFCIO Transaction Id. It is 256-bit hash
 */
