...
#ifdef DISABLE_DFCLIB_SERIALIZE
#include <dfciolib/serialize.hpp>
#undef DFCLIB_SERIALIZE
#define DFCLIB_SERIALIZE(...)
#endif
...
struct u128_action {
  ...
  DFCLIB_SERIALIZE( u128_action, (values) )
};
...
struct cf_action {
   ...
   DFCLIB_SERIALIZE( cf_action, (payload)(cfd_idx) )
};
...
struct dtt_action {
   ...
   DFCLIB_SERIALIZE( dtt_action, (payer)(deferred_account)(deferred_action)(permission_name)(delay_sec) )
};
...
struct invalid_access_action {
   ...
   DFCLIB_SERIALIZE( invalid_access_action, (code)(val)(index)(store) )
};
